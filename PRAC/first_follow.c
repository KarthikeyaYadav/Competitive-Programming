...
int main()
{
      ...
      {
            printf("\nEnter the production rule with terminal in capitals,non terminals in lower case and =,[%d]:\t", count + 1);
            scanf("%s", production[count]);
      }
      do
      {
            printf("\nEnter a terminal/non-terminal to Find First:\t");
            scanf(" %c", &ch);
            Find_First(array, ch);
            printf("\nFirst Value of %c:\t{ ", ch);
            ...
            printf("}\n");
            printf("To Continue, Press Y else to exit:\t");
            scanf(" %c", &option);
            ...
            if(production[count][0] == ch)
            {
                  ...
                  else
                  {
                        ...
                        while(production[count][j] != '\0')
                        {
                              ...
                              {
                                    Array_Manip(array,temporary_result[k]);
                              }
                              for(k = 0; temporary_result[k] != '\0'; k++)
                              {
...
void Array_Manip(char array[], char value)
{
      int temp;
